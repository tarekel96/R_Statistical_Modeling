...
For a **1000 unit increase in tuition**, the expected count of the response variable ($\lambda$ = estimated mean number of burglaries):

- tuition_thou: would decrease by a factor of approximately 0.9617923 holding all other variables constant.
