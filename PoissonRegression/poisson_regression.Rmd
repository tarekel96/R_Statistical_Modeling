...
- Explanatory Variable
  - $\beta_1$ is an indicator variable for indicating public or private school
...
- Explanatory Variable
  - $\beta_1$ is a continuous variable the amount of changes in trace minerals in the water over the last decade
